					...
					b.ui.mouse,
					{
						...
						_create : function() {
							...
							if (d.range) {
								...
								this.range.addClass("ui-widget-header-slider")
							}
							...
							this.handles = b(".ui-slider-handle", this.element)
									.addClass("ui-state-default-slider ui-corner-all-slider");
							...
							this.handles.add(this.range).filter("a").click(
								...
								if (!d.disabled) {
									b(this).addClass("ui-state-hover-slider")
								}
							}, function() {
								b(this).removeClass("ui-state-hover-slider")
							}).focus(
									function() {
										if (!d.disabled) {
						...
						_mouseCapture : function(e) {
							...
							var h = g.offset();
							var c = !b(e.target).parents().andSelf().is(
									".ui-slider-handle");
							this._clickOffset = c ? {
								left : 0,
								top : 0
